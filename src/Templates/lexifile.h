...
//	void				WriteLongString(const char *tag, const char *str);
	...
	void				WriteEnum(const char *tag, int val, const char **table);
	void				WriteEnum(const char *tag, int val, const char **table, int def) { if (val != def) WriteEnum(tag, val, table); }
	...
	void				WriteFlags(const char *tag, int val, const char **table) { if (val != 0) WriteFlagsAlways(tag, val, table); }
	void				WriteFlagsAlways(const char *tag, int val, const char **table);
	template<size_t N, typename Enum>
	void				WriteFlags(const char *tag, const BitFlags<N, Enum> &bf, const char **table) { if (bf.any()) WriteFlagsAlways(tag, bf.Wrap(), table); }
	template<size_t N, typename Enum>
	void				WriteFlagsAlways(const char *tag, const BitFlags<N, Enum> &bf, const char **table) { WriteFlagsAlways(tag, bf.Wrap(), table); }
	void				WriteFlagsAlways(const char *tag, BitFlagsWrapper::Ptr wrapper, const char **table);
