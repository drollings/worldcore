...
#include "Templates/lexistring.h"
#include "enum.h"
...
public:
	...
	virtual Lexi::String	print(const char **flags) const = 0;
...
public:
	...
	Lexi::String		print(const char **flags) const;
...
*/
	...
	public:
		...
		virtual Lexi::String	print(const char **flags) const { return bs.print(flags); }
...
extern Lexi::String PrintBitFlags(BitFlagsWrapper::Ptr bf, const char **flags);
...
Lexi::String BitFlags<N, Enum>::print(const char **flags) const
{
